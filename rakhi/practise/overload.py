...
class RakshaBandhanProgram:
    def __init__(self, root):
        ...
        # Create progress bar
        self.progress_bar = Progressbar(self.rightframe, orient="horizontal", length=300, mode="determinate")
        self.progress_bar.grid(row=len(question_data["answers"]) + 4, column=0, padx=20, pady=10, sticky="w")
